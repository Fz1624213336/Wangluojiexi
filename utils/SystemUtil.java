...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager onnectivityManager = (ConnectivityManager) BaceApplication.getApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo wifiInfo = onnectivityManager
    ...
    public static boolean isMobileNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) BaceApplication.getApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int dp2px(float dpValue) {
        final float scale = BaceApplication.getApplication().getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
    }
